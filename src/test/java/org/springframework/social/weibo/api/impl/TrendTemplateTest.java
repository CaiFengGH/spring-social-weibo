...
public class TrendTemplateTest extends AbstractWeiboOperationsTest {
    ...
    public void testGetTrendsPagination() {
        mockServer
                ...
                .andRespond(
                        withSuccess(jsonResource("userTrends"),
    ...
    public void testGetHourlyTrends() {
        mockServer
                ...
                .andExpect(header("Authorization", "OAuth2 accessToken"))
                .andRespond(
                        withSuccess(jsonResource("trends"), MediaType.APPLICATION_JSON));
    ...
    public void testFollow() {
        mockServer
                ...
                .andExpect(content().string("trend_name=%E8%8B%B9%E6%9E%9C"))
                .andExpect(header("Authorization", "OAuth2 accessToken"))
                .andRespond(
                        withSuccess("{\"topicid\":1568197}", MediaType.APPLICATION_JSON));
    ...
    public void testUnfollow() {
        mockServer
                ...
                .andExpect(method(POST)).andExpect(content().string("trend_id=1"))
                .andExpect(header("Authorization", "OAuth2 accessToken"))
